...
class mod_workshop_privacy_provider_testcase extends advanced_testcase {
     ...
     * @return boolean
     */
    protected function is_submission_erased($submissionid) {
        global $DB;
     ...
     * @return boolean
     */
    protected function is_received_assessment_erased($assessmentid) {
        global $DB;
     ...
     * @return boolean
     */
    protected function is_given_assessment_erased($assessmentid) {
        global $DB;
