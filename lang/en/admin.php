...
$string['configsmtpoauthservice'] = 'Select the OAuth 2 service that is configured to talk to the SMTP server. If the service does not exist yet, you will need to create it. Note that you need to set the SMTP Auth Type to OAUTH2.';
