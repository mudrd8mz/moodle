...
$string['brandingbrandcoloursacrosstheapplearnmore'] = 'Learn more about branding and customisation in the Moodle Apps Portal.';
$string['brandinginappsportal'] = 'Configure your brand colours in the Apps Portal';
...
$string['enabledeeplinkautologin'] = 'Deep link auto-login';
$string['enabledeeplinkautologin_desc'] = 'Automatically log users into their site within the mobile app when they open a deep link containing valid authentication tokens.';
...
$string['getmorefromcurrentsetup'] = 'Get more from your current setup';
...
$string['limitedmenuitems'] = 'Your <strong>{$a->plan}</strong> plan allows {$a->limit} items total across <strong>custom menu items</strong> and <strong>custom user menu items</strong>. <a href="{$a->url}">View plan details</a>.';
$string['limitedmenuitems_single'] = 'Your <strong>{$a->plan}</strong> plan allows {$a->limit} item total across <strong>custom menu items</strong> and <strong>custom user menu items</strong>. <a href="{$a->url}">View plan details</a>.';
$string['limitedcustomlangstrings'] = 'Your <strong>{$a->plan}</strong> plan allows {$a->limit} custom language strings. <a href="{$a->url}">View plan details</a>.';
$string['limitedcustomlangstrings_single'] = 'Your <strong>{$a->plan}</strong> plan allows {$a->limit} custom language string. <a href="{$a->url}">View plan details</a>.';
$string['limiteddisabledfeatures'] = 'Your <strong>{$a->plan}</strong> plan allows {$a->limit} disabled features. <a href="{$a->url}">View plan details</a>.';
$string['limiteddisabledfeatures_single'] = 'Your <strong>{$a->plan}</strong> plan allows {$a->limit} disabled feature. <a href="{$a->url}">View plan details</a>.';
...
$string['logocanappearapp'] = 'Your logo can appear in the Moodle app too';
$string['logocanappearapp_desc'] = 'Give learners a consistent branded experience across your site and mobile with a Premium plan.';
$string['logointheapp'] = 'Logo in the app';
$string['logointheapp_description'] = 'You\'ve set up your logo, but learners don\'t see it in the Moodle app yet.';
...
$string['lookingforcsscustomisation'] = 'Looking for CSS customisation?';
$string['lookingforcustomisationfeatures'] = 'Looking for customisation features?';
$string['lookingforqrcodelogin'] = 'Looking for QR code login?';
$string['mainmenu'] = 'Main menu';
$string['manage'] = 'Manage';
$string['managefiletypes'] = 'Manage file types';
$string['matomocantrackapp'] = 'Matomo can track the Moodle app too';
$string['matomocantrackapp_desc'] = 'You have set up Matomo for your site. With a Premium plan, your Matomo instance can also track how learners use the Moodle app.';
$string['matomointheapp'] = 'Matomo in the app';
$string['matomointheapp_description'] = 'Matomo is set up on your site, but it\'s not tracking your Moodle app yet.';
...
$string['modulenavigation'] = 'Linear activity navigation';
...
$string['notificationslimitreached'] = 'Monthly device limit reached. Some users are not receiving push notifications. Upgrade your plan to ensure all users receive mobile notifications.';
$string['notificationsmissingwarning'] = 'Unable to retrieve Moodle app notification statistics. Ensure mobile notifications are enabled in <a href="{$a}">Site administration > Messaging > Mobile</a>.';
...
$string['premiumfeatureonly'] = 'Premium feature only';
$string['premiumfeatures'] = 'Premium features';
$string['premiumonly'] = 'Premium only';
...
$string['refreshplanstatus'] = 'Refresh plan status';
...
$string['sectionnavigation'] = 'Linear section navigation';
...
$string['statisticstemporarilyunavailable'] = 'Notification statistics are temporarily unavailable. Notifications are still being delivered as normal. Check back soon.';
