...
$string['clistatusenabledlater'] = 'Status: Command Line Interface (CLI) maintenance mode will be enabled on {$a}';
...
$string['config_write_scope_desc'] = 'Allows modification of site configuration settings.';
$string['config_write_scope_summary'] = 'Manage site configuration settings';
...
$string['configdebugdisplay'] = 'If enabled, debug messages are displayed on the HTML page. This breaks XHTML, JavaScript, cookies and HTTP headers in general. Otherwise debug messages are stored in the server logs, allowing better debugging. The PHP setting error_log controls which log this goes to.';
...
$string['configenableasyncresets'] = 'If enabled, course resets are run as asynchronous ad-hoc tasks, preventing timeouts when resetting large courses.';
...
$string['configlangscrawlable'] = 'A comma-separated list of language codes (e.g. en,de,fr) that search engines are allowed to crawl and index. Any other active language packs will be redirected (canonicalised) to the site\'s default language. Codes must comply with HTML hreflang attribute standards. Non-standard language pack codes can be mapped using a pipe (e.g. de_kids|de). Only enable this setting if your public content is completely translated into all listed languages.';
...
$string['configmailnewline'] = 'Sets the line-ending format for outgoing mail. While the universal email standard RFC 822bis requires Carriage Return Line Feed (CRLF), mail servers vary in how they process these characters. Some automatically fix simple Line Feed (LF) endings, while others incorrectly create double-spaced lines (CRCRLF) or reject mails with bare LF. Change this setting if you have problems with undelivered emails or double newlines.';
...
$string['configpathtophp'] = 'Path to PHP Command Line Interface (CLI). Usually /usr/bin/php or similar. If you enter this, cron scripts can be executed from the admin web interface.';
...
$string['configsmtphosts'] = 'Give the full name of one or more local SMTP servers that Moodle should use to send mail (e.g. \'mail.a.com\' or \'mail.a.com;mail.b.com\'). To specify a non-default port (i.e other than port 25), use the [server]:[port] syntax (e.g. \'mail.a.com:587\'). For secure connections, port 465 is usually used with SSL, port 587 is usually used with Transport Layer Security (TLS). Specify the security protocol below if required. If you leave this field blank, Moodle will use the PHP default method of sending mail.';
...
$string['curlcache'] = 'cURL cache Time-to-Live (TTL)';
...
$string['displayerrorswarning'] = 'Enabling the PHP setting <em>display_errors</em> is not recommended on production sites, because error messages may reveal sensitive information about your server.';
...
$string['geoipfile'] = 'GeoIP City database';
...
$string['langscrawlable'] = 'Crawlable languages';
...
$string['mimetexdeprecated'] = 'MimeTeX is no longer supported. Please update your {$a->plugin_name} settings to use LaTeX. MathJax is recommended for mathematical formula rendering.';
...
$string['notificationctafeedbackbody'] = 'The site feedback survey is how admins tell Moodle HQ what to fix and what to build. Turning it on is easy.';
$string['notificationctafeedbackcaption'] = 'You can review exactly what’s collected first.';
$string['notificationctafeedbackcta'] = 'Enable the feedback survey';
$string['notificationctafeedbacktick1'] = 'Shapes the roadmap for every Moodle site.';
$string['notificationctafeedbacktick2'] = 'No user-identifying information is sent.';
$string['notificationctafeedbacktick3'] = 'Takes about 5 minutes, twice a year.';
$string['notificationctafeedbacktitle'] = 'Help decide what we build next';
$string['notificationctafromhqheading'] = 'From Moodle';
$string['notificationctafromhqsubtitle'] = 'Services, plugins and ways to shape the software you’re running.';
$string['notificationctamarketplacebody'] = 'Discover trusted plugins and integrations built for Moodle LMS.';
$string['notificationctamarketplacecaption'] = 'Opens marketplace.moodle.com in a new window.';
$string['notificationctamarketplacecta'] = 'Browse Moodle Marketplace';
$string['notificationctamarketplacetick1'] = '1,500+ plugins, themes and integrations.';
$string['notificationctamarketplacetick2'] = 'Certified integrations, vetted by Moodle.';
$string['notificationctamarketplacetick3'] = 'Free and paid listings in one catalogue.';
$string['notificationctamarketplacetitle'] = 'Moodle Marketplace';
$string['notificationctamoodlecloudbody'] = 'Need a second site for a pilot, a course build or a client? Get Moodle LMS hosted by Moodle, with nothing to maintain.';
$string['notificationctamoodlecloudcaption'] = 'Free 28-day trial · No credit card required.';
$string['notificationctamoodlecloudcta'] = 'Start your free trial';
$string['notificationctamoodlecloudtick1'] = 'Easy setup and no site maintenance.';
$string['notificationctamoodlecloudtick2'] = 'Unlimited courses and activities.';
$string['notificationctamoodlecloudtick3'] = 'Always on the latest supported release.';
$string['notificationctamoodlecloudtitle'] = 'MoodleCloud';
$string['notificationctapartnersbody'] = 'Explore trustworthy, Moodle-approved options for hosting, upgrades, integrations and custom development.';
$string['notificationctapartnerscaption'] = 'Opens moodle.com in a new window.';
$string['notificationctapartnerscta'] = 'Find a Moodle service provider';
$string['notificationctapartnerstick1'] = 'Full-service support and technical partnership.';
$string['notificationctapartnerstick2'] = 'Bespoke theming and custom development.';
$string['notificationctapartnerstick3'] = 'Scaled and audited for large institutions.';
$string['notificationctapartnerstitle'] = 'Moodle Services';
$string['notificationctaupdateschecked'] = 'Available updates were last checked {$a} ago.';
$string['notificationctaupdatesnotchecked'] = 'Available updates have never been checked.';
$string['notificationlabelcritical'] = 'Critical';
$string['notificationlabelnotice'] = 'Notice';
$string['notificationlabelsecurity'] = 'Security';
$string['notificationlabelwarning'] = 'Warning';
$string['notifications'] = 'Notifications';
$string['notificationsummarycritical'] = '{$a} critical';
$string['notificationsummarynotice'] = '{$a} notice';
$string['notificationsummarynoticeplural'] = '{$a} notices';
$string['notificationsummaryseparator'] = ' · ';
$string['notificationsummarywarning'] = '{$a} warning';
$string['notificationsummarywarningplural'] = '{$a} warnings';
...
$string['oauth2server_clientcallbackurirequired'] = 'At least one valid callback URI is required.';
...
$string['oauth2server_clientcreate'] = 'Create client';
$string['oauth2server_clientcreationwarning'] = 'Client type and primary flow can\'t be changed after creation.';
$string['oauth2server_clientcurrentlydisabled'] = 'This client is currently disabled.';
$string['oauth2server_clientdeleteactiondesc'] = 'This permanently removes the client, its secrets, and its redirect URIs. Unlike disabling, this can\'t be undone. Any integration using this client will stop working immediately.';
$string['oauth2server_clientdeleteactiontitle'] = 'Delete "{$a}"?';
$string['oauth2server_clientdisableactiondesc'] = 'Disabling the client immediately deactivates all of its secrets, preventing it from authenticating. The client, its configuration, and secrets are preserved, so it can be re-enabled later.';
$string['oauth2server_clientdisableactiontitle'] = 'Disable "{$a}"?';
$string['oauth2server_clientedit'] = 'Edit client';
$string['oauth2server_clientgranttypeauthcode'] = 'Authorization Code';
...
$string['oauth2server_clientnoactivesecretwarning'] = 'This confidential client does not have an active client secret. Generate a new client secret from the Manage secrets page to enable authentication.';
$string['oauth2server_clientpkce'] = 'Proof Key for Code Exchange';
$string['oauth2server_clientpkcerequired'] = 'Require PKCE';
$string['oauth2server_clientpkcerequiredconfidentialdesc'] = 'Require Proof Key for Code Exchange (PKCE) for this client. <br><br>For confidential clients using the Authorization Code flow, PKCE can be optional, or required.';
$string['oauth2server_clientpkcerequireddesc'] = 'Require Proof Key for Code Exchange (PKCE) for this client. <br><br>For confidential clients using the Authorization Code flow, PKCE can be optional, or required.<br>PKCE is required and cannot be disabled for public clients.';
$string['oauth2server_clientprimaryflows'] = 'Primary flows';
$string['oauth2server_clientreactivateactiondesc'] = 'This will restore this application\'s access to the authorization server. Any previously issued tokens remain invalid, and the client will need to re-authenticate or generate a new secret to resume normal operations.';
$string['oauth2server_clientreactivateactiontitle'] = 'Re-enable "{$a}"?';
$string['oauth2server_clientrevoked'] = 'Client "{$a}" has been revoked.';
$string['oauth2server_clientrevokesecretactiondesc'] = 'Any external applications or active integrations using this specific credential will instantly lose API access. This action is permanent and cannot be undone.';
$string['oauth2server_clientrevokesecretactiontitle'] = 'Revoke client secret?';
...
$string['oauth2server_clientsecretslimitreached'] = 'Maximum of {$a} secrets reached.';
$string['oauth2server_clientsecretvalue'] = 'Secret value';
$string['oauth2server_clienttype'] = 'Type';
$string['oauth2server_clienttypeconfidential'] = 'Confidential';
...
$string['oauth2server_clienttypepublicdesc'] = 'Runs on a device you don\'t control, like a mobile app. Can\'t hold a secret. Requires the use of PKCE.';
...
$string['oauth2server_expirycolumn_help'] = 'Expiry dates and times are displayed in your preferred time zone ({$a}).';
$string['oauth2server_managesecrets'] = 'Manage secrets';
$string['oauth2server_noactivesecrets'] = '<i class="fa fa-circle-info me-2"></i><strong>No client secrets are currently configured.</strong> <br /><br /> This OAuth 2 client cannot be used for authentication until an active client secret is added.';
...
$string['oauth2server_statusinactive'] = 'Inactive';
...
$string['openapi_required_scope_allof'] = 'all of:';
$string['openapi_required_scope_description'] = 'Required OAuth scopes:';
...
$string['scope_desc_admin_course_delete'] = 'Permanently delete courses and course categories';
$string['scope_desc_admin_course_read'] = 'View global course defaults, system category structures, and read the entire course registry catalog across the site without making changes.';
$string['scope_desc_admin_course_write'] = 'Create and modify courses and course categories, adjust site-wide course defaults.';
$string['scope_desc_admin_user_delete'] = 'Permanently delete user accounts, and trigger privacy data purges across the entire system.';
$string['scope_desc_admin_user_read'] = 'Query, search, and view core user account details and account suspension states';
$string['scope_desc_admin_user_write'] = 'Create new user accounts, update profile information, and manage suspension states across the system';
$string['scope_name_admin_course_delete'] = 'Delete site-wide courses and category structures';
$string['scope_name_admin_course_read'] = 'View site-wide course configurations and category structures';
$string['scope_name_admin_course_write'] = 'Manage site-wide course configurations and category structures';
$string['scope_name_admin_user_delete'] = 'Delete site-wide user accounts';
$string['scope_name_admin_user_read'] = 'View site-wide user accounts and profile data';
$string['scope_name_admin_user_write'] = 'Manage site-wide user accounts and profiles';
...
$string['searchteacherroles_desc'] = 'Select all roles that make users with the role rank higher in search results.';
...
$string['showuseridentity_desc'] = 'When selecting or searching for users, and when displaying lists of users, these fields may be shown in addition to full names. Fields are only shown to users who have the moodle/site:viewuseridentity capability; by default, teachers and managers. This setting makes most sense if you choose one or two fields that are mandatory at your institution.
...
$string['sitemaintenanceoncli'] = 'Your site is currently in Command Line Interface (CLI) maintenance mode. No web access is allowed.';
...
$string['siteparticipants'] = 'Site participants';
...
$string['tlswarning'] = 'No PHP/cURL extension with Transport Layer Security (TLS) 1.2 support has been detected. Some services may not work. It is strongly recommended to upgrade your TLS libraries.';
...
$string['upgradekeyerror'] = 'Incorrect upgrade key. Please check the value against $CFG->upgradekey in your site configuration.';
