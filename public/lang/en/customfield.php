...
$string['categoryconverted'] = 'The category has been successfully converted to shared custom fields';
...
$string['conversionerror'] = 'Cannot convert to shared custom fields';
$string['convertcategory'] = 'Convert to shared';
$string['convertcategoryconfirm'] = 'Are you sure you want to convert this category and all its fields to shared custom fields? This will make these fields available to all entities that support custom fields, such as courses, groups, cohorts, etc. <br/><br/>Once converted, the shared category will be enabled by default but can be disabled manually. </br><br/>This action cannot be undone.';
$string['convertcategorytitle'] = 'Convert to shared custom fields?';
$string['createnewcustomfield'] = 'Add field';
...
$string['sharedcustomfieldalreadyexists'] = 'One or more short names in this category already exist as shared custom fields. To proceed with the conversion, please rename the conflicting fields in this category or modify the existing shared custom fields.';
