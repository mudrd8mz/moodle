...
$string['activityiscurrentlyhidden'] = 'Activity not available. You don\'t have access to this activity. If you think this is a mistake, contact your teacher or instructor.';
...
$string['admin'] = 'Admin';
$string['adminheader'] = 'Site administration menu';
...
$string['deletingcourseasynchronously'] = 'The course {$a} will be deleted asynchronously';
$string['deletingcourseasynchronously_error'] = 'This course cannot be deleted at the moment. There is an existing backup or restore process for this course that needs to complete.';
$string['deletingcourseasynchronously_exception'] = 'This course will be deleted in a few moments. You can no longer access the course.';
...
$string['oauth2:confirmscopes:alreadygranted'] = 'You have already granted {$a->clientname} access to:';
$string['oauth2:confirmscopes:beforelist'] = 'When you allow this access, {$a->clientname} will be able to:';
$string['oauth2:confirmscopes:clientaccesstitle'] = '{$a->clientname} wants to access your {$a->sitename} account.';
$string['oauth2:confirmscopes:makesureyoutrust'] = 'Make sure you trust {$a->clientname}.';
$string['oauth2:confirmscopes:moodleaccount'] = 'To make changes at any time, go to your <a href="{$a->profilelink}">{$a->sitename} account</a>.';
...
$string['pat_copied'] = 'Copied to clipboard';
$string['pat_copytoken'] = 'Copy';
$string['pat_create'] = 'Create token';
$string['pat_createdwarning'] = 'This secret is shown only once. Copy it now - it can\'t be retrieved again after you leave the page.';
$string['pat_createheading'] = 'Create a personal access token';
$string['pat_createintro'] = 'Give the token a name and description so you can recognise it later, choose what it can access, and set when it expires. You won\'t be able to change these settings once the token is created.';
$string['pat_delete'] = 'Delete';
$string['pat_deleteactivewarning'] = 'This token is active and may be in use. Deleting it revokes access immediately, any application using it will stop working right away. This cannot be undone.';
$string['pat_deleteconfirm'] = 'Delete "{$a}"?';
$string['pat_deleted'] = 'Token deleted';
$string['pat_deleteexpiredwarning'] = 'This token already expired and can no longer be used. Deleting it just removes it from your list. This cannot be undone.';
$string['pat_description'] = 'Description';
$string['pat_expiringsoon'] = 'Expires within {$a} days';
$string['pat_expiry'] = 'Expiry date';
$string['pat_expiry1month'] = '1 month';
$string['pat_expiry1year'] = '1 year';
$string['pat_expiry2months'] = '2 months';
$string['pat_expiry3months'] = '3 months';
$string['pat_expiry7days'] = '7 days';
$string['pat_ip'] = 'IP: {$a}';
$string['pat_lastaccess'] = 'Last access';
$string['pat_lastaccessip'] = 'Last access IP';
$string['pat_name'] = 'Name';
$string['pat_never'] = 'Never';
$string['pat_neverused'] = 'Never used';
$string['pat_newtoken'] = 'Your new token: {$a}';
$string['pat_none'] = 'You have no personal access tokens.';
$string['pat_revoke'] = 'Revoke';
$string['pat_revokeconfirm'] = 'Revoke "{$a}"?';
$string['pat_revoked'] = 'Token revoked';
$string['pat_scopes'] = 'Scopes';
$string['pat_scopesinfo'] = 'The token can only do what its scopes allow.';
$string['pat_status'] = 'Status';
$string['pat_statusactive'] = 'Active';
$string['pat_statusexpired'] = 'Expired';
$string['pat_timecreated'] = 'Created';
$string['pat_timecreated_help'] = 'Creation dates and times are displayed in your preferred time zone ({$a}).';
$string['pat_validuntil'] = 'Valid until';
$string['pat_validuntil_help'] = 'The token stops working at this moment. Expiry dates and times are displayed in your preferred time zone ({$a}).';
$string['path'] = 'Path';
...
$string['personalaccesstokens'] = 'Personal access tokens';
$string['personalaccesstokensintro'] = 'Tokens let external applications act on your behalf using the web services API.<br>Anyone with a token can do anything you can do within its selected scopes, so keep tokens private and delete any you no longer use.';
...
$string['privacy:metadata:oauth2_server_client_access_tokens'] = 'The OAuth 2.0 access tokens used for communication with external services';
$string['privacy:metadata:oauth2_server_client_access_tokens:userid'] = 'The ID of the user who owns the access token';
$string['privacy:metadata:oauth2_server_client_auth_codes'] = 'The OAuth 2.0 authorisation codes used for communication with external services';
$string['privacy:metadata:oauth2_server_client_auth_codes:userid'] = 'The ID of the user who owns the authorisation code';
$string['privacy:metadata:oauth2_server_client_granted_scopes'] = 'The OAuth 2.0 granted scopes used for communication with external services';
$string['privacy:metadata:oauth2_server_client_granted_scopes:userid'] = 'The ID of the user who owns the granted scopes';
$string['privacy:metadata:rest_api_tokens'] = 'Personal access tokens used for communication with external services';
$string['privacy:metadata:rest_api_tokens:lastaccessed'] = 'The time a personal access token was last used to authenticate a request';
$string['privacy:metadata:rest_api_tokens:lastaccessip'] = 'The IP address a personal access token was last used from';
$string['privacy:metadata:rest_api_tokens:userid'] = 'The ID of the user who owns a personal access token';
...
$string['unknown_scope_description'] = 'A placeholder scope used when the server does not know about a requested scope.';
$string['unknown_scope_summary'] = 'Unknown scope';
