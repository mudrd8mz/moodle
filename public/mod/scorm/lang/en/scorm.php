...
$string['package_help'] = 'The package file is a ZIP file containing Sharable Content Object Reference Model (SCORM) or Aviation Industry Computer-Based Training Committee (AICC) course definition files.';
