...
$string['selectuserinstructions'] = 'In single view you can override or exclude selected grades and bulk insert grades.';
$string['selectgradeinstructions'] = 'In single view you can override or exclude selected grades and bulk insert grades.';
$string['selectgradeitemlink'] = 'Select a grade item';
$string['whattoview'] = 'Single view';
$string['whattoviewselect'] = 'View all the grades of a single user or grade item.';
